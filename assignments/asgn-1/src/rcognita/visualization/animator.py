...
from src.rcognita import ANIMATION_TYPES_SAVE_FORMATS
...
from src.rcognita.__utilities import on_key_press, on_close
...
class Animator:
    ...
    def save_animation(self):
        if self.animation_type == "html":
            ...
            self.anm.save(
                "/mnt/c/Users/RLead/Documents/Мои репозитории/classedu2023-advctrl/assignments/asgn-1/src/animation.mp4",
                writer=writer,
            )
