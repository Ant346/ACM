...
class System(RcognitaBase, ABC):
    ...
    # class DefaultAnimation(rcognita.AnimationCallback):
    ...
    #             "reset_iteration"
    #         ]
    #         return isinstance(obj, rcognita.scenarios.OnlineScenario) and any([method == target_method for target_method in target_methods])
